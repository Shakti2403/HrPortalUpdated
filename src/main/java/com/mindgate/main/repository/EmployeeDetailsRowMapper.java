...
public class EmployeeDetailsRowMapper implements RowMapper<EmployeeDetails> {
	...
	public EmployeeDetails mapRow(ResultSet rs, int rowNum) throws SQLException {
		...
		EmployeeDetails employeeDetails = new EmployeeDetails(employeeId, firstName, lastName, contact, designation, skill1, skill2, skill3, bench, salary, address,city,street, pin, userId, project_id);
